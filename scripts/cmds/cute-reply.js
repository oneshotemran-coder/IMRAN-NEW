...
const TRIGGERS = [
  ...
  // 🟢 FARHAN SYSTEM
  {
    ...
    texts: [
      ...
      "🔥 বস ইমরান কে ডাকিস না পারলে একটা জি এফ দে...!😃",
      "😎 চুমু খাওয়ার বয়স টা আমার বস ইমরান চকলেট🍫খেয়ে উড়িয়ে দিল 🤗",
      "👉 আমার বস ♻️ 𝗩𝗞 𝗜𝗠𝗥𝗔𝗡 এখন বিজি আছে । তার ইনবক্সে এ মেসেজ দিয়ে রাখো https://m.me/imran.boss.420 🔰 ♪√বস ফ্রি হলে আসবে🧡😁😜"
    ],
  ...
  // 🤖 MENTION SYSTEM
  {
    ...
    replies: [
      ...
      {
        text: "😽 আমি একটা বট, বস ইমরান বানাইছে 😎",
